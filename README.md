...
[![Build Status](https://img.shields.io/badge/Build-Passing-brightgreen?style=for-the-badge)](https://github.com/chudmc/pathmind)
...
1. **Clone the Repository**
   ```bash
   git clone https://github.com/chudmc/pathmind.git
   cd pathmind
   ```
...
- **Bug Reports**: [Open an Issue](https://github.com/chudmc/pathmind/issues/new?template=bug_report.md)
- **Feature Requests**: [Open an Issue](https://github.com/chudmc/pathmind/issues/new?template=feature_request.md)
...
- **Issues**: [GitHub Issues](https://github.com/chudmc/pathmind/issues)
...
[![GitHub](https://img.shields.io/badge/GitHub-Repository-black?style=for-the-badge&logo=github)](https://github.com/chudmc/pathmind)
